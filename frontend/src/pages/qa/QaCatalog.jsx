...
//     P1     → 底纹 #f3c9af / 条子 #f99140 / 图标 #cf6c16     全在 60°
...
// —— 底纹档：标签的底。前三支（坏/要处理/好）取**等绝对彩度** C*21.6 @ L*84；
// 第四支淡紫压到 C*18 —— 它管的是「不着急」，不该跟三支表态的一样响。
// 压下来恰好落在相对彩度 60%，跟条子那两支淡紫（58% / 60%）对上，两处紫是同一族。
...
// 四支互相的 dE：最近的一对是 红↔琥珀 12.6，其余 26~40。12.6 足够分开，
