...
①-A 【预期从哪来 —— 这一条最要紧，看漏了整批用例都白写】
   ...
   **人只在两个点上花时间：定需求、确认 bug。** 其余全是你的判断。
